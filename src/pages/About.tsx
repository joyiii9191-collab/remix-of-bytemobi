    ...
    <SnapPage title="关于我们">
      ...
      <SnapScreen id="timeline" bg="tint" snap={false}>
        <ScreenInner className="!justify-start py-12 md:py-16">
          <ScreenTitle>发展历程 · 里程碑</ScreenTitle>
              ...
              >
                ...
                <div className="px-3 md:px-3.5 py-2.5 md:py-3 flex flex-col gap-1">
                  ...
                  <div className="flex flex-col gap-1 text-[10.5px] md:text-[11px]">
                    <span className="font-medium tabular-nums tracking-wide truncate" style={{ color: ACCENT }}>
                      {e.date}
                    </span>
                    <span className="truncate leading-snug" style={{ color: TEXT_MID }} title={`${e.city} · ${e.location}`}>
