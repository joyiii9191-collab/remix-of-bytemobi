        ...
        <ScreenInner>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div
                  className="absolute -top-10 -right-10 w-32 h-32 rounded-full opacity-20 transition-opacity duration-500 group-hover:opacity-40"
                  style={{ background: `radial-gradient(circle, ${JP_RED} 0%, transparent 70%)` }}
                />
                <div className="relative">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-3"
                    style={{ background: JP_RED_SOFT, color: JP_RED }}><Users size={22} /></div>
              ...
              >
                ...
                <div className="relative">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-3"
                    style={{ background: JP_RED_SOFT, color: JP_RED }}><Languages size={22} /></div>
                  <div className="flex items-baseline gap-1 mb-1">
                    <div className="text-5xl font-bold"
                      style={{
                        background: `linear-gradient(180deg, hsl(245 70% 30%) 0%, ${JP_RED} 100%)`,
                  ...
                  <div className="text-xs mt-0.5" style={{ color: TEXT_MID }}>深度融入本地市场</div>
                  {/* 占比条 */}
                  <div className="mt-3 h-1.5 rounded-full overflow-hidden" style={{ background: JP_RED_SOFT }}>
                    <motion.div
              ...
              <motion.div
                ...
                className="group relative rounded-2xl p-6 sm:col-span-2 glass-card overflow-hidden"
                style={CARD}
              >
                <div
                  className="absolute -bottom-12 -right-12 w-40 h-40 rounded-full opacity-15 transition-opacity duration-500 group-hover:opacity-30"
                  style={{ background: `radial-gradient(circle, ${JP_RED} 0%, transparent 70%)` }}
                />
                <div className="relative flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0"
                    style={{ background: JP_RED_SOFT, color: JP_RED }}><Building2 size={22} /></div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm leading-relaxed mb-3" style={{ color: TEXT_MID }}>
                      本地团队 · 本地运营 · 本地融入,商务、运营、技术与合规一体化协作。
                    </p>
                    <div
                      className="flex items-start gap-2 text-xs leading-relaxed rounded-lg px-3 py-2"
                      style={{ background: "hsla(245, 60%, 45%, 0.05)", color: TEXT_MID }}
                    >
                      <Building2 size={14} className="shrink-0 mt-0.5" style={{ color: JP_RED }} />
