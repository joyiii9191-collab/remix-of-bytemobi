      ...
      <div className="fixed z-30 top-28 left-0 right-0 pointer-events-none">
        <div className="max-w-[1200px] mx-auto px-6">
          <Link
            ...
            aria-label="返回增长成果精选"
            title="返回增长成果精选"
            className="group pointer-events-auto inline-flex items-center justify-center w-8 h-8 -ml-1 transition-all hover:-translate-x-0.5 hover:opacity-70"
            style={{ color: TEXT_MID }}
          >
            <ArrowLeft size={20} strokeWidth={2.25} className="transition-transform group-hover:-translate-x-0.5" />
          </Link>
        </div>
      </div>
